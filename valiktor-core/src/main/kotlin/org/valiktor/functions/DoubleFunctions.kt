 ...
 */
fun <E> Validator<E>.Property<Double?>.isZero(): Validator<E>.Property<Double?> = this.validate(Equals(0.0)) { it == null || it == 0.0 }
 ...
 * @return the same receiver property
 */
fun <E> Validator<E>.Property<Double?>.isOne(): Validator<E>.Property<Double?> = this.validate(Equals(1.0)) { it == null || it == 1.0 }
 ...
 * @return the same receiver property
 */
fun <E> Validator<E>.Property<Double?>.isPositive(): Validator<E>.Property<Double?> = this.validate(Greater(0.0)) { it == null || it > 0.0 }
 ...
 * @return the same receiver property
 */
fun <E> Validator<E>.Property<Double?>.isNegative(): Validator<E>.Property<Double?> = this.validate(Less(0.0)) { it == null || it < 0.0 }
 ...
 * @return the same receiver property
 */
fun <E> Validator<E>.Property<Double?>.hasIntegerDigits(
    min: Int = Int.MIN_VALUE,
    max: Int = Int.MAX_VALUE,
): Validator<E>.Property<Double?> =
 ...
 * @return the same receiver property
 */
fun <E> Validator<E>.Property<Double?>.hasDecimalDigits(
    min: Int = Int.MIN_VALUE,
    max: Int = Int.MAX_VALUE,
): Validator<E>.Property<Double?> =
